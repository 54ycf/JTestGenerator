...
public class MySootAPI {
    @Test
    public void MyJimpleDemo() {
        ...
        for (Local l : body.getLocals()) {
            ...
            System.out.println("****Class : " + l.getClass().getSimpleName().toString());
        ...
        for (Unit u : body.getUnits()) {
            ...
            System.out.println("****Class: " + u.getClass().getSimpleName());
